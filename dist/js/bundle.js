...
document.addEventListener("DOMContentLoaded", function () {
  ...
  }, 600000); // const diffTime = Math.abs(new Date().getTimezoneOffset() / 60);
  // const deadline = `2020-07-24T00:00:00+0${diffTime}:00`;

  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_1__["default"])(".tabcontainer", ".tabheader__item", ".tabcontent", "tabheader__item_active");
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])("[data-modal]", ".modal", modalTimerId);
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])(".timer", "2020-07-08T00:00:00");
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_cards__WEBPACK_IMPORTED_MODULE_5__["default"])(26);
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_6__["default"])(modalTimerId, "form");
...
function calc() {
  ...
  function getDynamicInformation(selector) {
    ...
    input.addEventListener("input", function () {
      var checkInput = new Promise(function (resolve, reject) {
        if (input.value.match(/\D/g)) {
          input.style.border = "1px solid red";
          input.style.backgroundColor = "pink";
          var checkValue = input.value.replace(/\D/g, "");
          setTimeout(function () {
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  var modalOpenBtn = document.querySelectorAll(triggerSelector),
...
function tabs(tabsParentSelector, tabsSelector, tabsContentSelector, activeClass) {
  var tabsParent = document.querySelector(tabsParentSelector),
      ...
      tabsContent = tabsParent.querySelectorAll(tabsContentSelector);
